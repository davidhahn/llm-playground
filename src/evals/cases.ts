...
export const agentCases: EvalCase[] = [
  ...
  {
    id: 'agent-03',
    question: 'How much PTO does david.hahn have remaining?',
  ...
  {
    id: 'agent-06',
    question: "What is david.hahn's role and department?",
  ...
  {
    id: 'agent-09',
    question: 'How much PTO does david.hahn get given his tenure?',
